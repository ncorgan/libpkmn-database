...
IF( SQLITE3_FOUND )
    ...
    # Cache variables
    SET(SQLITE3_INCLUDE_DIR ${SQLITE_INCLUDE_DIR} CACHE STRING "SQLite3 include dir")
    SET(SQLITE3_LIBRARY_RELEASE ${SQLITE_LIBRARY_RELEASE} CACHE STRING "SQLite3 library release")
    SET(SQLITE3_LIBRARY_DEBUG ${SQLITE_LIBRARY_DEBUG} CACHE STRING "SQLite3 library debug")
    SET(SQLITE3_EXECUTABLE ${SQLITE_EXECUTABLE} CACHE STRING "SQLite3 executable")
ELSE(SQLITE3_FOUND)
